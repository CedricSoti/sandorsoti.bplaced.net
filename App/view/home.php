...
<body>
  ...
  <?php
  $team = [
    ['name' => 'Cédric Sándor Soti', 'role' => 'CEO & Founder', 'img' => 'Ich1.jpg', 'desc' => 'Visionärer Kopf hinter BR Architects.', 'portfolio' => 'portfolio_ceo.html'],
    ['name' => 'Cédric Sándor Soti', 'role' => 'Architect',       'img' => 'Ich1.jpg', 'desc' => 'Plant moderne und nachhaltige Gebäude.', 'portfolio' => 'portfolio_architect.html'],
    ['name' => 'Cédric Sándor Soti', 'role' => 'Lernender',       'img' => 'Ich1.jpg', 'desc' => 'Lernt täglich Neues im Architekturbüro.', 'portfolio' => 'portfolio_learner.html'],
    ['name' => 'Cédric Sándor Soti', 'role' => 'Manager',         'img' => 'Ich1.jpg', 'desc' => 'Organisiert und koordiniert das Team.',  'portfolio' => 'portfolio_manager.html'],
  ];
  foreach ($team as $member): ?>
    <div class="w3-col l3 m6 w3-margin-bottom">
      ...
      <p><?= htmlspecialchars($member['desc'], ENT_QUOTES); ?></p>
      
      <p>
        <a href="/public/portfolio/<?= htmlspecialchars($member['portfolio'], ENT_QUOTES); ?>" class="w3-button w3-black w3-white-text w3-block" target="_blank">
          Portfolio ansehen
        </a>
      </p>
